...
/* harmony import */ var _js_ProjectItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/ProjectItem */ "./src/js/ProjectItem.js");
...
projectItemConfig.forEach((item, index) => {
    let generated = new _js_ProjectItem__WEBPACK_IMPORTED_MODULE_2__.ProjectItem(item).generateItem(index);
...
itemsWrapper.addEventListener('click', (e) => {
    if (e.target.closest('li')) {
        ...
        new _js_ProjectItem__WEBPACK_IMPORTED_MODULE_2__.ProjectItem(item).generateModal();
    }
});
